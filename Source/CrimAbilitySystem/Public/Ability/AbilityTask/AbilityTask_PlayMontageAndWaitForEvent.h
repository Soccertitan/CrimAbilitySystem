...
/** Signature type used, EventTag and Payload may be empty if it came from the montage callbacks */
 ...
 */
UCLASS()
class CRIMABILITYSYSTEM_API UAbilityTask_PlayMontageAndWaitForEvent : public UAbilityTask
{
	GENERATED_BODY()

 ...
 */
UCLASS()
class CRIMABILITYSYSTEM_API UAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	UPROPERTY(EditDefaultsOnly, Category = Ability, meta = (TitleProperty = "Ability Tag"))

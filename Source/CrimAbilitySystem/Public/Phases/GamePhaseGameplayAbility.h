...
#include "GamePhaseGameplayAbility.generated.h"

/**
 * The base gameplay ability for any ability that is used to change the active game phase.
 */
UCLASS(Abstract, HideCategories = Input)
class CRIMABILITYSYSTEM_API UGamePhaseGameplayAbility : public UCrimGameplayAbility
{
	GENERATED_BODY()

public:
	UGamePhaseGameplayAbility();
...
protected:
	...
	/**
	 * Defines the game phase that this game phase ability is part of. For example,
	 ...
	 * you can also nest the phases. For example, GamePhase.Playing.NormalPlay, is a sub-phase
	 ...
	 */
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Crim Ability System|Game Phase")
